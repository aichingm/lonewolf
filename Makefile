...
.PHONY: default build-web check container container-force dev-tauri dev-web favicon lint lint-web lint-tauri npm-install npm-install-web npm-install-tauri shell shell-web shell-tauri type-check type-check-web type-check-tauri
